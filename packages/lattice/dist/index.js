...
const { TAU }=__require(1);
const { segmentDistance }=__require(2);
...
export const LATTICE_WGSL=__entry.LATTICE_WGSL;
export const cubicLattice=__entry.cubicLattice;
export const octetLattice=__entry.octetLattice;
export const tpms=__entry.tpms;
