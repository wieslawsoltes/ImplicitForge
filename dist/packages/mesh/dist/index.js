...
const { gridInfo, clamp, throwIfAborted, vec3 }=__require(1);
...
export const extractMesh=__entry.extractMesh;
export const meshMetrics=__entry.meshMetrics;
export const meshToVolume=__entry.meshToVolume;
export const sampleGrid=__entry.sampleGrid;
export const weldMesh=__entry.weldMesh;
