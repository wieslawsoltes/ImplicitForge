...
const { Emitter, clone }=__require(1);
...
function serializeProject(doc) { validateDocument(doc); return JSON.stringify(doc, (_, v) => v instanceof Float32Array ? Array.from(v) : v, 2); }
function parseProject(text) { if (text.length > 100 * 1024 * 1024)
...
Object.assign(__exports,{DocumentStore:DocumentStore,serializeProject:serializeProject,parseProject:parseProject,ProjectPersistence:ProjectPersistence});
},
...
export const DocumentStore=__entry.DocumentStore;
export const ProjectPersistence=__entry.ProjectPersistence;
export const parseProject=__entry.parseProject;
export const serializeProject=__entry.serializeProject;
